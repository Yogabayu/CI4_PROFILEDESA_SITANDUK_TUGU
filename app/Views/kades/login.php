...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('public/admin/images/ponorogo.PNG'); ?>">
                            ...
                            <div class="account-box">
                                <div class="account-logo-box">
                                    <div class="text-center">
                                        ...
                                        <img class="rounded-circle" src="<?php echo base_url(' public/admin/images/ponorogo.PNG'); ?>" width="20%">
                                        <br> <br>
                                    </div>
                                    <center>
